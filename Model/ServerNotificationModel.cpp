#include "ServerNotificationModel.h"

CServerNotificationModel::CServerNotificationModel(void)
{
}
...
BSONObj CServerNotificationModel::GetNotificationInfo(BSONObj boCIInfo, BSONObj boNewCIInfo)
{
	BSONObj boAPIFields;
